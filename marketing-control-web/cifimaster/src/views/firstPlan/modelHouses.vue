<template>
  <div class="modelHouses">
              ...
              <template slot-scope="scope">
                <div class="fileBox" v-if="scope.$index<accessoryData.length-1">
                  <el-upload
                    ...
                    :on-exceed="exceed"
                    :action="action"
                    :data="{'filePath':'modelHouses','bizID':'','orderIndex':scope.$index}"
                ...
                <div class="fileBox" :style="{height: fileHeight*40+'px'}" v-else>
                  <el-upload
                    ...
                    :on-error="fileError"
                  >
                    <el-button v-if="isSubmit!=4" type="text">+{{scope.row.handle}}</el-button>
                  </el-upload>
                </div>
              </template>
            </el-table-column>
    ...
    <div class="bottom" v-if="isType!='view'">
      <el-button type="primary" v-if="isSubmit!=4" @click="saveData('submit')">提交</el-button>
      <el-button type="primary" v-if="isSubmit!=4" @click="saveData('save')">保存</el-button>
    </div>
  </div>
</template>
  ...
  methods: {
    ...
    queryOpenMonth() {
      ...
      queryOpenMonth({
        ...
        console.log(this.accessoryData, "111111");
    ...
    fileUpload: function(event) {
      ...
      formData.append("filePath", "modelHouses");
