<template>
  <div class="threeMonthInfo" ref="threeMonthInfo">
            ...
            <div class="node" id="node">
              ...
              >
                ...
                <el-table-column align="center" prop="little_per" label="小卡率(%)">
                  <template
                    slot-scope="scope"
                  >{{scope.row.little_per? scope.row.little_per + '%' : scope.row.little_per}}</template>
                </el-table-column>
                <el-table-column align="center" prop="big_num" label="大卡(组)"></el-table-column>
                <el-table-column align="center" prop="big_per" label="大卡率(%)">
                  <template
                    slot-scope="scope"
                  >{{scope.row.big_per? scope.row.big_per + '%' : scope.row.big_per}}</template>
                </el-table-column>
            ...
            <div class="come" id="come">
              ...
              >
                ...
                <el-table-column align="center" prop="plan_task_per" label="计划阶段任务占比(%)">
                  ...
                  <span>{{scope.row.plan_task_per ? scope.row.plan_task_per + '%' : scope.row.plan_task_per}}</span>
                  </template>
                </el-table-column>
                ...
                <el-table-column align="center" prop="actual_task_per" label="实际阶段任务占比(%)">
                  ...
                  <span v-else>{{scope.row.actual_task_per}}</span>
                  </template>-->
                </el-table-column>
...
export default {
  ...
  mounted() {
    let timeid = setTimeout(() => {
      if (window.cifioa) {
        console.log(this.$refs.threeMonthInfo.offsetHeight);
        window.cifioa.sendMessage({
          type: "height",
          height: this.$refs.threeMonthInfo.offsetHeight
        });
      } else {
