  ...
  <div class="app-container" >
    <div class="container-header">
      ...
      <div class="search-top">
        ...
        <div class="search-top-right">
          <el-button
            ...
            @click="drawer = true;formLabelAlign.value='项目级'"
          ...
          <div class="grid-content bg-purple bg-purple-right">
            <el-table :data="tableData" class="etable" :style="heightleft">
              ...
              <el-table-column label="操作" width="100">
                <template slot-scope="scope" v-if="scope.row.DictionaryLevel==2&&scope.row.IsReadOnly == 0">
      ...
      >
       ...
       <!--   <el-form-item label="排序号">
            <el-input v-model=" type="number" min="0" max="255"/>
          </el-form-item>-->
          <el-form-item label="排序号">
            <el-input-number v-model="formLabelAlign.ListIndex" :min="1" :max="99" label="排序号"></el-input-number>
          </el-form-item>
