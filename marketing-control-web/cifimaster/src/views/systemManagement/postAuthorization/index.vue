      ...
      <el-col :span="19">
        <div class="content-right clearfix">
          <div class="btn btn-news">
            <el-button type="primary" class="bgc_blue" @click="addHandler">+新增岗位</el-button>
            ...
            <!-- <el-button type="primary" class="bgc_blue" @click="functionAuthorization">功能授权</el-button> -->
    ...
    >
      ...
      >
        ...
        <el-form-item label="状态" prop="Status">
          <el-select v-model="addForm.Status" placeholder="启用" style="width:100%">
